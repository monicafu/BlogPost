 ...
 */
final class Version20190805225010 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blog_post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, published DATETIME DEFAULT NULL, content CLOB DEFAULT NULL, author VARCHAR(255) DEFAULT NULL)');
